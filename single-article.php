...
<h1>Hunde i Hjemmet</h1>
  ...
  <div class="billede-tekst">
    <img src="http://sejr-og-davidsen.local/wp-content/uploads/2023/09/hund-og-hjemmet.jpg" alt="Hunde i Hjemmet" width="840" height="500">
  ...
  <div class="billede-tekst">
    <img src="http://sejr-og-davidsen.local/wp-content/uploads/2023/09/Hund-ved-computer-scaled.jpg" alt="Hunde i Hjemmet" width="840" height="500">
        ...
        <img src="http://sejr-og-davidsen.local/wp-content/uploads/2023/09/hunde-krammer-scaled.jpg" alt="Hunde i Hjemmet" width="840" height="500">
  </div>
  <div class="parent">
    <div class="billede-venstre"> 
        <img src="http://sejr-og-davidsen.local/wp-content/uploads/2023/09/hund-krammer-ejer-scaled.jpg" alt="Hunde i Hjemmet" width="840" height="500">
    </div>
    <div class="billede-højre"> 
        <img src="http://sejr-og-davidsen.local/wp-content/uploads/2023/09/hund-leger-med-ejer-scaled.jpg" alt="Hunde i Hjemmet" width="840" height="500">
    </div>
    </div>
    ...
    <section class="relateret-artikler">
        <div class="separator"></div>
